<x-admin-layout>
    ...
    <div class="mt-3 grid grid-cols-1 place-items-center gap-4 text-wrap md:grid-cols-2 lg:grid-cols-4">
        @foreach ($productos as $producto)
            <div class="flex h-96 w-fit flex-col rounded-lg bg-white text-center shadow">
